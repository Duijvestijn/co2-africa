...
export default function NewsletterSection() {
  ...
  return (
    <section id="newsletter" className="bg-af-sienna py-20 md:py-28">
        ...
        {status === "success" ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-xl mx-auto">
            ...
            <button
              ...
              className="px-6 py-3 bg-white text-af-sienna font-bold text-sm rounded-xl hover:bg-white/90 transition-colors disabled:opacity-60 whitespace-nowrap"
            >
